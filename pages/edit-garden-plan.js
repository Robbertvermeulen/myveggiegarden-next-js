...
import GardenSeedling from "../components/GardenSeedlings";
...
export default function gardenPlanEditor({ data }) {
  ...
  const getSeedling = (id) => {
    return state.seedling.find((item) => {
      return item.id === id;
    });
  };
  ...
  return (
    <GardenPlanContext.Provider value={[state, dispatch]}>
      <div className="garden-plan-editor">
        <div class="grid gap-4 lg:grid-cols-12 lg:gap-10">
          <div class="col-span-full lg:col-span-3">
            <div className="p-8 rounded bg-white border border-[rgba(0,0,0,0.15)] shadow-sm">
              ...
              <div className="mb-6">
                ...
                <div className="mb-5">
                  <Field
                    ...
                    value={(state.actualLength && state.actualLength / 2) || ""}
                    changeHandler={(e) =>
                      dispatch({
                ...
                <div className="mb-5">
                  <Field
                    ...
                    placeholder={settings.sizeUnit}
                    value={(state.actualWidth && state.actualWidth / 2) || ""}
                    changeHandler={(e) =>
                      dispatch({
              ...
              <button className="button button-primary shadow-md">Save</button>
            </div>
          </div>
          <div class="col-span-full lg:col-span-9 relative">
            <div className="mb-6">
              <div className="mb-6">
